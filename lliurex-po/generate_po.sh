...
xgettext --join-existing -kde -ki18nd:2 ../lliurex-permission-control.install/ui/rsrc/Settings.qml -o ../lliurex-po/lliurex-permission-control/lliurex-permission-control.pot
