...
xgettext --join-existing -kde -ki18nd:2 ../lliurex-permission-control.install/ui/rsrc/StudentList.qml -o ../lliurex-po/lliurex-permission-control/lliurex-permission-control.pot
xgettext --join-existing -kde -ki18nd:2 ../lliurex-permission-control.install/ui/rsrc/ListDelegateStudentItem.qml -o ../lliurex-po/lliurex-permission-control/lliurex-permission-control.pot
...
xgettext --join-existing -kde -ki18nd:2 ../lliurex-permission-control.install/ui/rsrc/TeacherList.qml -o ../lliurex-po/lliurex-permission-control/lliurex-permission-control.pot
xgettext --join-existing -kde -ki18nd:2 ../lliurex-permission-control.install/ui/rsrc/ListDelegateTeacherItem.qml -o ../lliurex-po/lliurex-permission-control/lliurex-permission-control.pot
