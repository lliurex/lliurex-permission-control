...
ApplicationWindow {
    ...
    id:mainWindow
    visible: true
    title: "LliureX Permission Control"
    color:"#eff0f1"
    ...
    onClosing: {
        ...
        permissionControlBridge.closeApplication()
        delay(100, function() {
            if (permissionControlBridge.closeGui){
                closing=true,
                closeTimer.stop(),           
                mainWindow.close();
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Image{
                id:banner
                source: "/usr/share/lliurex-permission-control/rsrc/banner.png"
            }
        }

        StackView {
            id: mainView
            property int currentIndex:permissionControlBridge.currentStack
            implicitWidth: 670
